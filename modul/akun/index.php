...
<tbody>
    ...
    <!-- Modal -->
    <div class="modal fade" id="editAkun<?= $data['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"> <form action="modul/akun/aksi_akun.php?act=update&id=<?= $data['id'] ? >" method="post">
